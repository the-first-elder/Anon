...
export declare class BarretenbergLazy extends BarretenbergApi {
    private constructor();
    private static new;
    static getSingleton(): Promise<BarretenbergLazy>;
    getWasm(): BarretenbergWasmMain | BarretenbergWasmMainWorker;
}
