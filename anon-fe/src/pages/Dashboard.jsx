...
import { signMessageAndGetPubkey } from "../constant/merkleTree";
...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      <h2 className="text-Roboto font-bold lg:text-[28px] md:text-[24px] text-[20px] my-6 text-center">Join a forum.</h2>
      <section className="border border-black/40 rounded-3xl p-8 lg:w-[50%] md:w-[50%] w-[90%] mx-auto">
        ...
        <div className="my-4 rounded-lg shadow-lg p-4 lg:w-[49%] md:w-[48%] w-[100%] border border-gray-300">
            ...
            <button className="text-white bg-dark p-3 rounded-lg w-[100%]" onClick={() => signMessageAndGetPubkey(signer, "Verification process", allNft)}>Verify</button>
        </div>
        </div>
        <div>
        </div>
